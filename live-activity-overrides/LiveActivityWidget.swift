...
// LiveActivityAttributes copy for the widget extension target.
// Shape MUST match node_modules/expo-live-activity/ios/LiveActivityAttributes.swift exactly.
  ...
  private func dynamicIslandExpandedLeading(title: String, subtitle: String?) -> some View {
    VStack(alignment: .leading) {
      ...
      Text(title)
        ...
        .fontWeight(.semibold)
      if let subtitle, !subtitle.hasPrefix("[") {
        Text(subtitle)
          .font(.title3)
          .minimumScaleFactor(0.8)
